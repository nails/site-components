                ...
                <div class="row">
                    ...
                    <div class="col-md-4 text-center">
                        <ul class="list-inline social-buttons">
                            <li>
                                <a href="http://twitter.com/shedcollective"><i class="fa fa-twitter"></i></a>
                            </li>
                            <li>
                                <a href="http://facebook.com/shedcollective"><i class="fa fa-facebook"></i></a>
                            </li>
                            <li>
                                <a href="http://instagram.com/shedhq"><i class="fa fa-instagram"></i></a>
                            </li>
                        </ul>
                    </div>
